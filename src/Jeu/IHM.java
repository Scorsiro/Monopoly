...
public class IHM {
    ...
    System.out.println("*                      *    Avenue    *              *   Boulevard  *    Avenue    *     Gare     *   Faubourg   *   Place de   * Compagnie de *    Rue la    *                      *");
      ...
      System.out.print("*  J:");affJ(21,mono);System.out.print("            *"+B_RED+"J:");affJ(22,mono);System.out.print("      "+B_RESET+"*J:");affJ(23,mono);System.out.print("      *"+B_RED+"J:");affJ(24,mono);System.out.print("      "+B_RESET+"*"+B_RED+"J:");affJ(25,mono);System.out.print("      "+B_RESET+"*J:");affJ(26,mono);System.out.print("      *"+B_YELLOW+"J:");affJ(27,mono);System.out.print("      "+B_RESET+"*J:");affJ(28,mono);System.out.print("      *"+B_YELLOW+"J:");affJ(29,mono);System.out.print("      "+B_RESET+"*"+B_YELLOW+"J:");affJ(30,mono);System.out.print("      "+B_RESET+"*J:");affJ(31,mono);System.out.print("              *"); System.out.println("   Position : " + mono.getJoueurs().get(2).getPositionCourante().getNomCarreau()); 
      System.out.print("**************************************************************************************************************************************************************************************"); System.out.println("**************************");
      System.out.print("* Place       *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"* Avenue de   *");if(mono.getJoueurs().size()>3){System.out.println("   Joueur 3 : " + mono.getJoueurs().get(3).getNomJoueur());} else{System.out.println("");}
      System.out.print("*   Pigalle   *J:");affJ(20,mono);System.out.print("*                                                                                                                                      *"+B_GREEN+"J:");affJ(32,mono);System.out.print(""+B_RESET+"*    Breteuil *");if(mono.getJoueurs().size()>3){System.out.println("      Solde : " + mono.getJoueurs().get(3).getCash());}else{System.out.println("");}
      System.out.print("*             *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*             *");if(mono.getJoueurs().size()>3){System.out.println("   Position : " + mono.getJoueurs().get(3).getPositionCourante().getNomCarreau());}else{System.out.println("");} 
      System.out.print("*     200€    *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*     300€    *");if(mono.getJoueurs().size()>3){System.out.println("**************************");}else{System.out.println("");}
      ...
      System.out.print("*  Boulevard  *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"* Avenue      *");if(mono.getJoueurs().size()>4){System.out.println("      Solde : " + mono.getJoueurs().get(4).getCash());}else{System.out.println("");}
      System.out.print("* Saint-Michel*J:");affJ(19,mono);System.out.print("*                                                                                                                                      *"+B_GREEN+"J:");affJ(33,mono);System.out.print(""+B_RESET+"*      Foch   *");if(mono.getJoueurs().size()>4){System.out.println("   Position : " + mono.getJoueurs().get(4).getPositionCourante().getNomCarreau());}else{System.out.println("");}
      System.out.print("*             *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*             *");if(mono.getJoueurs().size()>4){System.out.println("**************************");}else{System.out.println("");}
      System.out.print("*     180€    *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*     300€    *");if(mono.getJoueurs().size()>5){System.out.println("   Joueur 5 : " + mono.getJoueurs().get(5).getNomJoueur());} else{System.out.println("");}
      ...
      System.out.print("*   Avenue    *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*Boulevard des*");if(mono.getJoueurs().size()>6){System.out.println("**************************");}else{System.out.println("");}
      System.out.print("*    Mozart   *J:");affJ(17,mono);System.out.print("*                                                                                                                                      *"+B_GREEN+"J:");affJ(35,mono);System.out.println(""+B_RESET+"*  Capucines  *");
    System.out.println("*             *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*             *");
    System.out.println("*     180€    *        *                                                                                                                                      *"+B_GREEN+"        "+B_RESET+"*     320€    *");
    System.out.println("************************                                                                                                                                      ************************");
